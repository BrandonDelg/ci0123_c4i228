...
//
//	Five kinds of synchronization are defined here: semaphores,
//	locks, condition variables, mutes, and barrier.  The implementation for
//	semaphores is given; for the others, only the procedure
