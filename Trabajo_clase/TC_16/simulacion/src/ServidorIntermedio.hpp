...
class ServidorIntermedio {
    public:
        ...
        Cliente* getCliente();
        void registrarFiguraLocal(const std::string& figura);
        void conectarIntermediario(ServidorIntermedio* peer);
        void recibirHandshake(ServidorIntermedio* peer, const std::set<std::string>& figurasPeer);
        std::string atenderRequestIntermediario(const std::string& msg);
        std::string consultarPeer(const std::string& figura, int mitad);
    ...
    private:
        ...
        std::map<std::string, ServidorIntermedio*> tablaGlobal;
        std::set<std::string> figurasLocales;
